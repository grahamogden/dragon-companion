...
<template>
  <div class="campaign-picker relative bg-horizon-light bg-contain h-36 w-full flex flex-col justify-end"
    ...
    <div v-if="campaignStore.isCampaignSelected" class="px-4 py-2 bg-timberwolf-50/90 dark:bg-woodsmoke-950/90 backdrop-blur-sm duration-500">
