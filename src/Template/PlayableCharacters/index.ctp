 ...
 * @var \App\Model\Entity\PlayableCharacter[]|\Cake\Collection\CollectionInterface $playableCharacters
 */
?>
...
<div class="playableCharacters index large-9 medium-8 columns content">
    <h3><?= __('Playable Characters') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('armour_class') ?></th>
                <th scope="col" class="actions"><?= __('Actions') ?></th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($playableCharacters as $playableCharacter): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $playableCharacter->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $playableCharacter->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $playableCharacter->id], ['confirm' => __('Are you sure you want to delete # {0}?', $playableCharacter->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
