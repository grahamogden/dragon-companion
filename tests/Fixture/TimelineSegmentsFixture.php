...
class TimelineSegmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 2000, 'null' => false, 'default' => '', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'timeline_segments_ibfk_1' => ['type' => 'foreign', 'columns' => ['campaign_id'], 'references' => ['campaigns', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'timeline_segments_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-04-10 19:59:32',
                'modified' => '2020-04-10 19:59:32',
